...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      onPrimaryFixedVariant: Color(0xff1e4875),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(0xff1e4875),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(0xffddc1e8),
      onTertiary: Color(0xff200e2b),
      tertiaryContainer: Color(0xffa188ac),
      ...
      inversePrimary: Color(0xff1f4977),
      primaryFixed: Color(0xffd3e4ff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffddc1e8),
      onTertiaryContainer: Color(0xff000000),
